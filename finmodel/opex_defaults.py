...
def build_default_opex_cost_pools(yearly_opex: Dict[str, float]) -> List[OpexCostPool]:
    ...
    return [
        ...
        OpexCostPool("Supplies", "Production", pool_amounts["Supplies"], driver_type=OpexDriverType.BATCH_COUNT, classification=OpexCostClassification.VARIABLE),
        ...
        OpexCostPool("Transport", "Logistics", pool_amounts["Transport"], driver_type=OpexDriverType.SHIPMENT_COUNT),
        ...
        OpexCostPool("Quality Control", "Quality", pool_amounts["Quality Control"], driver_type=OpexDriverType.LITERS, rules=[OpexAllocationRule(driver=OpexDriverType.LITERS, weight=0.7), OpexAllocationRule(driver=OpexDriverType.BATCH_COUNT, weight=0.2), OpexAllocationRule(driver=OpexDriverType.ACTIVE_SKU, weight=0.1)]),
        OpexCostPool("Certificates", "Regulatory", pool_amounts["Certificates"], driver_type=OpexDriverType.ACTIVE_SKU, two_stage_family_allocation=True, second_stage_driver=OpexDriverType.ACTIVE_SKU),
